...
def classify(model_filename, test_img_dir):
    ...
    return img_classes
model = BirdsClassifier.load_from_checkpoint(checkpoint_path="/home/bakyt/Prog/CV/birds/epoch=13-valid_accs=0.800.ckpt")
sd = model.state_dict()
torch.save(sd, "birds_model.pt")
...
# train_classifier(train_gt, train_img_dir, True)